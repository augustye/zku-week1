...
describe("HelloWorld", function () {
    ...
    it("Should return true for correct proof", async function () {
        ...
        //show output from public data
        console.log('2x3 =',publicSignals[0]);
        
        //get calldata for contract
        const calldata = await groth16.exportSolidityCallData(proof, publicSignals);
    
        //convert calldata format
        ...
        //call contract and check result
...
describe("Multiplier3 with PLONK", function () {
    ...
    it("Should return true for correct proof", async function () {
        //get proof and public data
        const { proof, publicSignals } = await groth16.fullProve({"a":"2","b":"3","c":"5"}, "contracts/circuits/Multiplier3_plonk/Multiplier3_js/Multiplier3.wasm","contracts/circuits/Multiplier3_plonk/circuit_final.zkey");
